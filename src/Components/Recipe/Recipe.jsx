...
export default function Recipe({props}) {
  ...
  const {idMeal, strMeal, strArea, strMealThumb} = props;
  ...
  return (
    <>
      <div className="meal text-center hover:shadow-xl group  hover:scale-105 duration-300 transition-all bg-white p-12 pb-4  rounded-[35px]">
        ...
        {strArea && <h5 className="flex justify-center items-center gap-2 text-emerald-600">
